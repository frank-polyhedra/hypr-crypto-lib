...
use algebra::ed25519::{Ed25519Point, Ed25519Scalar, ED25519_D};
use algebra::prelude::*;
use algebra::zorro::{PedersenCommitmentZorro, ZorroG1, ZorroProof, ZorroScalar};
...
pub struct ScalarMulProof(#[serde(with = "obj_serde")] pub(crate) ZorroProof);
