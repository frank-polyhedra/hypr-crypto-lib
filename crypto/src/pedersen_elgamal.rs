...
use algebra::prelude::*;
use algebra::ristretto::PedersenCommitmentRistretto;
...
mod test {
    ...
    use algebra::prelude::*;
    use algebra::ristretto::{PedersenCommitmentRistretto, RistrettoPoint, RistrettoScalar};
    use algebra::traits::PedersenCommitment;
    use merlin::Transcript;
